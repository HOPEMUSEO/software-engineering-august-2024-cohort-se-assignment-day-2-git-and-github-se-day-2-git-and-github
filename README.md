...
Name the Repository: Choose a unique name that reflects the project's purpose.
...
2. Make Changes: Edit files or add new ones to your project.
3. Stage Changes: Use `git add` to stage the changes you want to commit.
4. Commit Changes: Execute `git commit -m "Your commit message"` to record the changes with a descriptive message.
